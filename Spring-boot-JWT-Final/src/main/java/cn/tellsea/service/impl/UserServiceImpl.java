...
public class UserServiceImpl implements UserService {
    ...
    public User checkUserPass(String name, String password) {
        ...
        User res = userMapper.checkUserPass(name, password);
    ...
    public String selectByPage(Integer offset, Integer limit, String name, String email, String address) {
        ...
        BootstrapTable res = new BootstrapTable(userMapper.selectCount(null),
                userMapper.selectByPage(offset, limit, name, email, address));
         ...
         * + address + "%"); } List<User> list = userMapper.selectByExample(example);
         * return JSON.toJSONString(new BootstrapTable(userMapper.selectCount(null),
         * list));
         */
    }
